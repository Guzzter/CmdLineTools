...
namespace VideoThumbnailer
{
    public class FFmpegMediaInfo
    {
        ...
        public FFmpegMediaInfo(string filename, string FFPROBE_EXE_PATH)
            : this()
        {
        ...
        /// </summary>
        /// <param name="atPosition">A time position within the duration of the video</param>
        public Bitmap GetSnapshot(TimeSpan atPosition, string FFMPEG_EXE_PATH)
        {
            ...
            // Prepare a temporary file for commandline usage
    ...
    public class Utils
    {
        ...
        /// </summary>
        public static string CheckRelativePath(string path)
        {
